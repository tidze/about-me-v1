...
@section('content')
    ...
    <div class="bg-zinc-800 flex justify-center p-2" style="">
        <div class="flex items-center flex-col md:flex-row w-full md:w-2/3 ">
    ...
    <div class="flex flex-col items-center md:flex-row md:justify-center border bg-zinc-900">
        ...
        <div
            class="border w-64 h-72 md:w-56 md:h-64 m-2 rounded cursor-pointer hover:bg-gradient-to-t hover:from-white">
